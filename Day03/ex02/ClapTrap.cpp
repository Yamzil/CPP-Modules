...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/10/09 16:38:51 by yamzil            #+#    #+#             */
/*   Updated: 2022/10/25 17:25:02 by yamzil           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap(std::string name)
    : name(name), Hit_points(100), Energy_points(100), Attack_damage(30) {std::cout << "ClapTrap's constructor" << std::endl;}
